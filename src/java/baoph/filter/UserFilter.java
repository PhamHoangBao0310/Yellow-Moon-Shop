...
public class UserFilter implements Filter {
    ...
    static Logger logger = Logger.getLogger(UserFilter.class);
...
//        }
        ...
        logger.info("UserFilter is called");
        ...
        try {
            ...
            problem = t;
            logger.error("UserFilter - Throwable " + t.getMessage());
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                logger.info("UserFilter:Initializing filter");
            }
        }
    }
