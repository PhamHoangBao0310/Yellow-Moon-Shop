...
public class AdminFilter implements Filter {
    ...
    static Logger logger = Logger.getLogger(AdminFilter.class);
...
//        }
        logger.info("AdminFilter is called ");
        ...
        try {
            ...
            if (session == null) {
                ...
                if (user == null) {
                    ...
                    if (roleDao.getRole(user.getRoleID()).equals("Admin")) {
            ...
            problem = t;
            logger.error("AdminFilter - Throwable : " + t.getMessage());
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                logger.info("AdminFilter:Initializing filter");
            }
        }
    }
